...
import Octicon, { Star, Organization, Pin, KebabVertical, Pulse, Calendar } from '@primer/octicons-react'
...
class MovieItem extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <img
          className={poster_path ? "movie-img img-thumbnail" : "movie-img unknown-thumbnail"}
            ...
            <div style={{ width: '100%' }}>
              ...
              <div  className="details-div">
                <div className="details-div-item">
                  <Octicon className="rate-start-icon" size='medium' icon={Star} />
                  <strong> {vote_average ? vote_average : "Unavailable"} </strong>
                </div>
                <div className="details-div-item">
                  <Octicon className="users-votes-icon" size={20} icon={Organization} />
                  <strong> {vote_count ? vote_count : "Unavailable"}</strong>
                </div>
                <div className="details-div-item">
                  <Octicon className="users-votes-icon" size={20} icon={Pulse} />
                  <strong>{popularity ? popularity : "Unavailable"}</strong>
                </div>
                <div className="details-div-item">
                  <Octicon className="users-votes-icon" size={20} icon={Calendar} />
